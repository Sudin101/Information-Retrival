...
class SearchEngine(object):
    ...
    def __init__(own, api_key):
        own.engine = Serp(api_key)

    
    def acl(own, keyword, max_pages = None):
        result  = own.engine.google_search(
            f'site:aclanthology.org {keyword}', 
                                            max_pages)
        return result
    
    def pmlr(own, keyword, max_pages = None):
        result  = own.engine.google_search(
            f'site:proceedings.mlr.press {keyword}', 
                                            max_pages)
        return result
    
    def arxiv(own, keyword, max_pages = None):
        result  = own.engine.google_search(
    ...
    def semantic_scholar(own, keyword, max_pages = None):
        result  = own.engine.google_search(
    ...
    def nips(own, keyword, max_pages = None):
        result  = own.engine.google_search(
    ...
    def ijcai(own, keyword, max_pages = None):
        result  = own.engine.google_search(
    ...
    def openreview(own, keyword, max_pages = None):
        result  = own.engine.google_search(
            f'site:openreview.net {keyword}', 
                                            max_pages)
        return result
    
    def cvf(own, keyword, max_pages = None):
        result  = own.engine.google_search(
            f'site:openaccess.thecvf.com {keyword}', 
                                            max_pages)
        return result
    
    def google_scholar(own, keyword, max_pages = None):
        result  = own.engine.google_search(
            f'site:scholar.google.com {keyword}', 
                                            max_pages)
        return result
    
    def google_scholar_internal(own, keyword, max_pages = None):
        result = own.engine.google_scholar_search(keyword, 
                                                   max_pages)
        return result
    
    def custom_search(own, url, keyword, max_pages = None):
        result  = own.engine.google_search(
            f'site:{url} {keyword}', max_pages)
        return result


    def all_related_papers(own, query):
        ...
        rl_resultgp = own.engine.get_related_pages(query)
